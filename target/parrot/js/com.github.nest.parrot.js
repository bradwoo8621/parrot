/** com.github.nest.parrot.V0.0.6 2015-12-05 */
(function ($) {
	var patches = {
		console: function () {
...
(function(context, $, moment, $pt) {
	var NDateTime2 = React.createClass($pt.defineCellComponent({
		...
		renderHeaderMonth: function(date) {
			return (React.createElement("span", {onClick: this.renderPopover.bind(this, {date: date, type: NDateTime2.FORMAT_TYPES.MONTH}), className: "header-date-btn"}, 
				this.convertValueToString(date, this.getHeaderMonthFormat())
			));
		},
		renderHeaderYear: function(date) {
			return (React.createElement("span", {onClick: this.renderPopover.bind(this, {date: date, type: NDateTime2.FORMAT_TYPES.YEAR}), className: "header-date-btn"}, 
		...
		renderHourHand: function(date, radius, offset) {
			...
			return (React.createElement("line", {x1: offset + NDateTime2.CLOCK_HAND_OFFSET * Math.cos(Math.PI * 2 * (degree - 180) / 360), 
			...
			return (React.createElement("div", {className: "time-view", style: styles}, 
				...
				React.createElement("div", {className: "calendar-body"}, 
					React.createElement("div", {className: "time-view-body-body"}, 
						React.createElement("svg", {className: "clock", height: NDateTime2.CLOCK_RADIUS * 2, width: NDateTime2.CLOCK_RADIUS * 2}, 
							React.createElement("circle", {className: "primary", 
							...
							React.createElement("text", {className: "text hour top-num", 
								  x: NDateTime2.CLOCK_CHAR_POS.TOP.X, 
								  y: NDateTime2.CLOCK_CHAR_POS.TOP.Y + NDateTime2.CLOCK_RADIUS - hourRadius}, "0"), 
							React.createElement("text", {className: "text hour left-num", 
								  x: NDateTime2.CLOCK_CHAR_POS.LEFT.X + NDateTime2.CLOCK_RADIUS - hourRadius, 
								  y: NDateTime2.CLOCK_CHAR_POS.LEFT.Y}, "18"), 
							React.createElement("text", {className: "text hour right-num", 
								  x: NDateTime2.CLOCK_CHAR_POS.RIGHT.X - NDateTime2.CLOCK_RADIUS + hourRadius, 
								  y: NDateTime2.CLOCK_CHAR_POS.RIGHT.Y}, "6"), 
							React.createElement("text", {className: "text hour bottom-num", 
								  x: NDateTime2.CLOCK_CHAR_POS.BOTTOM.X, 
								  y: NDateTime2.CLOCK_CHAR_POS.BOTTOM.Y - NDateTime2.CLOCK_RADIUS + hourRadius}, "12"), 
		...
		renderPopover: function(options) {
			...
			var popover = (React.createElement("div", {role: "tooltip", className: "n-datetime popover bottom in", style: styles}, 
