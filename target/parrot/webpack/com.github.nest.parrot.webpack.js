...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsface = __webpack_require__(4);
	var browser = __webpack_require__(5);
	var deparam = __webpack_require__(6);
	var wheel = __webpack_require__(7);
	var fileInput = __webpack_require__(8);
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			...
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, this.getCodeTable().list().map(this.renderItem.bind(this, enabled)));
			},
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderItem: function (item, itemIndex) {
				...
				return React.createElement("div", { className: "row", key: itemIndex }, React.createElement("div", { className: "col-sm-12 col-md-12 col-lg-12" }, React.createElement($pt.Components.NPanel, { model: model,
	   ...
	   */
			render: function () {
				return React.createElement("div", { className: this.getComponentCSS('n-array-panel') }, this.getValueFromModel().map(this.renderItem));
			},
			/**
	   * return [] when is null
	   * @returns {[*]}
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: this.getComponentCSS('n-array-tab') }, React.createElement($pt.Components.NTab, { type: this.getComponentOption('tabType'),
					...
					ref: "tabs" }), React.createElement("div", { className: "n-array-tab-content", ref: "content" }, tabs.map(this.renderTabContent)));
			},
	   ...
	   */
			...
			renderMoreButtons: function (css) {
				...
				if (more) {
					var dropdown = React.createElement("a", { href: "javascript:void(0);",
						...
						"aria-haspopup": "true",
						"aria-expanded": "false",
						key: "a" }, React.createElement("span", { className: "caret" }));
					var emptyFunction = function () {};
					var _this = this;
					var menus = React.createElement("ul", { className: "dropdown-menu", key: "ul" }, more.map(function (menu, menuIndex) {
						if (menu.divider) {
							...
							return React.createElement("li", { key: menuIndex }, React.createElement("a", { href: "javascript:void(0);", onClick: click.bind(_this, _this.getModel()) }, icon, label));
						}
					}));
			...
			render: function () {
				...
				if (this.getLabelPosition() === 'left') {
					...
					// label in left
					return React.createElement("div", { className: $pt.LayoutHelper.classSet(compCSS) }, React.createElement("div", { className: "btn-group" }, React.createElement("a", { href: "javascript:void(0);",
						className: $pt.LayoutHelper.classSet(css),
						onClick: this.onClicked,
						disabled: !this.isEnabled(),
						title: this.getComponentOption('tooltip'),
						ref: "a" }, label, icon), this.renderMoreButtons(css)));
				} else {
					if (label && icon) {
						label = ' ' + label;
					}
					...
					return React.createElement("div", { className: $pt.LayoutHelper.classSet(compCSS) }, React.createElement("div", { className: "btn-group" }, React.createElement("a", { href: "javascript:void(0);",
						...
						disabled: !this.isEnabled(),
						title: this.getComponentOption('tooltip'),
						ref: "a" }, icon, label), this.renderMoreButtons(css)));
				}
			},
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderLabel: function (labelInLeft) {
				if (this.isLabelAttached()) {
					...
					return React.createElement("span", { className: $pt.LayoutHelper.classSet(css),
						onClick: enabled && !this.isViewMode() ? this.onButtonClicked : null }, this.getLayout().getLabel());
				}
				return null;
			},
			/**
	   ...
	   */
			renderCheckbox: function () {
				...
				return React.createElement("div", { className: "check-container" }, React.createElement("span", { className: $pt.LayoutHelper.classSet(css),
					onClick: enabled && !this.isViewMode() ? this.onButtonClicked : null,
					onKeyUp: enabled && !this.isViewMode() ? this.onKeyUp : null,
					tabIndex: "0",
					ref: "out" }, React.createElement("span", { className: "check", onClick: this.onInnerClicked })));
			},
			/**
	   * render
	   * @returns {XML}
	   */
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, isLabelAtLeft ? this.renderLabel(true) : null, this.renderCheckbox(), !isLabelAtLeft ? this.renderLabel(false) : null);
			},
			/**
	...
	(function (window, $, moment, React, $pt) {
		var NDateTime = React.createClass($pt.defineCellComponent({
			...
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(divCSS) }, React.createElement("div", { className: "input-group", ref: "comp" }, React.createElement("input", { type: "text",
					className: "form-control",
					disabled: !this.isEnabled(),
					onChange: this.onTextInputChange,
					onFocus: this.onTextInputFocused,
					onBlur: this.onTextInputBlurred,
					ref: "text" }), React.createElement("span", { className: $pt.LayoutHelper.classSet(css) }, this.renderIcon({ icon: this.getIcon('calendar'), click: this.onCalendarButtonClicked }))), this.renderNormalLine(), this.renderFocusLine());
			},
			renderHeaderMonth: function (date) {
				return React.createElement("span", { onClick: this.renderPopover.bind(this, { date: date, type: NDateTime.FORMAT_TYPES.MONTH }),
					...
					key: "header-month" }, this.convertValueToString(date, this.getHeaderMonthFormat()));
			},
			renderHeaderYear: function (date) {
				return React.createElement("span", { onClick: this.renderPopover.bind(this, { date: date, type: NDateTime.FORMAT_TYPES.YEAR }),
					className: "header-date-btn",
					key: "header-year" }, this.convertValueToString(date, this.getHeaderYearFormat()));
			},
			renderDayHeader: function (date) {
				...
				return React.createElement("div", { className: "calendar-header day-view" }, this.renderIcon({
				...
				}), monthFirst ? mainHeader : mainHeader.reverse(), this.renderIcon({
			...
			renderDayBody: function (date) {
				...
				return React.createElement("div", { className: "calendar-body day-view" }, React.createElement("div", { className: "day-view-body-header row" }, header.map(function (weekday, weekdayIndex) {
					return React.createElement("div", { className: "cell-7-1", key: 'weekday-' + weekdayIndex }, weekday);
				})), React.createElement("div", { className: "day-view-body-body row" }, days.map(function (day, dayIndex) {
					var css = {
						'cell-7-1': true,
					...
					return React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
						...
						key: 'day-' + dayIndex }, React.createElement("span", null, day.date()));
				})));
			},
			renderMonthHeader: function (date) {
				return React.createElement("div", { className: "calendar-header month-view" }, this.renderIcon({
					icon: 'angle-double-left',
					className: 'header-btn left',
				...
				}), this.renderHeaderYear(date), this.renderIcon({
					icon: 'angle-double-right',
					className: 'header-btn right',
			...
			renderMonthBody: function (date) {
				...
				var value = this.getValueFromModel();
				var today = this.getToday();
				return React.createElement("div", { className: "calendar-body month-view" }, React.createElement("div", { className: "month-view-body-body row" }, months.map(function (month, index) {
			...
			renderYearHeader: function (date) {
				...
				return React.createElement("div", { className: "calendar-header year-view" }, this.renderIcon({
					icon: 'angle-double-left',
					className: 'header-btn left',
			...
			renderYearBody: function (date) {
				...
				return React.createElement("div", { className: "calendar-body month-view" }, React.createElement("div", { className: "year-view-body-body row" }, years.map(function (year, yearIndex) {
					var css = {
						'cell-4-1': true,
					...
					return React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
						...
						key: yearIndex }, year.format(_this.getBodyYearFormat()));
				})));
			},
			renderPopoverContentFooterButton: function (options) {
				return React.createElement("div", { className: "cell-3-1", onClick: options.click }, this.renderIcon({ icon: this.getIcon(options.icon) }));
			},
			renderPopoverContentFooter: function (today, type) {
				return React.createElement("div", { className: "calendar-footer row" }, this.renderPopoverContentFooterButton({
					icon: 'today',
			...
			render12HourDial: function (date, popoverType) {
				...
				return React.createElement("g", { key: "hour-12-dial" }, React.createElement("text", { className: 'text hour-12 am' + (am ? ' yes' : ''),
					onClick: this.onAMPMSelected.bind(this, true, popoverType),
					x: 0,
					y: 0 }, "AM"), React.createElement("text", { className: 'text hour-12 pm' + (am ? '' : ' yes'),
					onClick: this.onAMPMSelected.bind(this, false, popoverType),
					x: NDateTime.CLOCK_RADIUS * 2,
					y: 0 }, "PM"), React.createElement("text", { className: "text hour-12 top-num",
					x: NDateTime.CLOCK_CHAR_POS.TOP.X,
					y: NDateTime.CLOCK_CHAR_POS.TOP.Y + NDateTime.CLOCK_RADIUS - hourRadius }, "0"), React.createElement("text", { className: "text hour-12 left-num",
					x: NDateTime.CLOCK_CHAR_POS.LEFT.X + NDateTime.CLOCK_RADIUS - hourRadius,
					y: NDateTime.CLOCK_CHAR_POS.LEFT.Y }, "9"), React.createElement("text", { className: "text hour-12 right-num",
					x: NDateTime.CLOCK_CHAR_POS.RIGHT.X - NDateTime.CLOCK_RADIUS + hourRadius,
					y: NDateTime.CLOCK_CHAR_POS.RIGHT.Y }, "3"), React.createElement("text", { className: "text hour-12 bottom-num",
					x: NDateTime.CLOCK_CHAR_POS.BOTTOM.X,
					y: NDateTime.CLOCK_CHAR_POS.BOTTOM.Y - NDateTime.CLOCK_RADIUS + hourRadius }, "6"), [30, 60, 120, 150, 210, 240, 300, 330].map(function (degree) {
			...
			render24HourDial: function () {
				var _this = this;
				var hourRadius = this.getHourRadius();
				return React.createElement("g", { key: "hour-24-dial" }, React.createElement("text", { className: "text hour-24 top-num",
					x: NDateTime.CLOCK_CHAR_POS.TOP.X,
					y: NDateTime.CLOCK_CHAR_POS.TOP.Y + NDateTime.CLOCK_RADIUS - hourRadius }, "0"), React.createElement("text", { className: "text hour-24 left-num",
					x: NDateTime.CLOCK_CHAR_POS.LEFT.X + NDateTime.CLOCK_RADIUS - hourRadius,
					y: NDateTime.CLOCK_CHAR_POS.LEFT.Y }, "18"), React.createElement("text", { className: "text hour-24 right-num",
					x: NDateTime.CLOCK_CHAR_POS.RIGHT.X - NDateTime.CLOCK_RADIUS + hourRadius,
					y: NDateTime.CLOCK_CHAR_POS.RIGHT.Y }, "6"), React.createElement("text", { className: "text hour-24 bottom-num",
					x: NDateTime.CLOCK_CHAR_POS.BOTTOM.X,
					y: NDateTime.CLOCK_CHAR_POS.BOTTOM.Y - NDateTime.CLOCK_RADIUS + hourRadius }, "12"), [45, 135, 225, 315].map(function (degree) {
			...
			renderMinuteDial: function () {
				...
				var _this = this;
				return React.createElement("g", { key: "minute-dial" }, React.createElement("text", { className: "text minute top-num",
					x: NDateTime.CLOCK_CHAR_POS.TOP.X,
					y: NDateTime.CLOCK_CHAR_POS.TOP.Y }, "0"), React.createElement("text", { className: "text minute left-num",
					x: NDateTime.CLOCK_CHAR_POS.LEFT.X,
					y: NDateTime.CLOCK_CHAR_POS.LEFT.Y }, "45"), React.createElement("text", { className: "text minute right-num",
					x: NDateTime.CLOCK_CHAR_POS.RIGHT.X,
					y: NDateTime.CLOCK_CHAR_POS.RIGHT.Y }, "15"), React.createElement("text", { className: "text minute bottom-num",
					x: NDateTime.CLOCK_CHAR_POS.BOTTOM.X,
					y: NDateTime.CLOCK_CHAR_POS.BOTTOM.Y }, "30"), [30, 60, 120, 150, 210, 240, 300, 330].map(function (degree) {
	   ...
	   */
			renderPopoverContent: function (date, popoverType) {
				...
				if ((popoverType & NDateTime.FORMAT_TYPES.DAY) != 0) {
					...
					return React.createElement("div", { className: "popover-content row" }, React.createElement("div", { className: "date-view", style: styles }, this.renderDayHeader(date), this.renderDayBody(date), this.renderPopoverContentFooter(this.getToday(), NDateTime.FORMAT_TYPES.DAY)), this.renderTime(date, NDateTime.FORMAT_TYPES.DAY));
				} else if ((popoverType & NDateTime.FORMAT_TYPES.MONTH) != 0) {
					// has month, YM
					this.startClockInterval(NDateTime.FORMAT_TYPES.MONTH);
					return React.createElement("div", { className: "popover-content row" }, React.createElement("div", { className: "date-view", style: styles }, this.renderMonthHeader(date), this.renderMonthBody(date), this.renderPopoverContentFooter(this.getToday(), NDateTime.FORMAT_TYPES.MONTH)), this.renderTime(date, NDateTime.FORMAT_TYPES.MONTH));
				} else if ((popoverType & NDateTime.FORMAT_TYPES.YEAR) != 0) {
					// has year, YEAR
					this.startClockInterval(NDateTime.FORMAT_TYPES.YEAR);
					return React.createElement("div", { className: "popover-content row" }, React.createElement("div", { className: "date-view", style: styles }, this.renderYearHeader(date), this.renderYearBody(date), this.renderPopoverContentFooter(this.getToday(), NDateTime.FORMAT_TYPES.YEAR)), this.renderTime(date, NDateTime.FORMAT_TYPES.YEAR));
				} else {
	   ...
	   */
			renderPopover: function (options) {
				...
				var popover = React.createElement("div", { role: "tooltip", className: $pt.LayoutHelper.classSet(popoverCSS), style: styles }, React.createElement("div", { className: "arrow" }), this.renderPopoverContent(options.date, options.type));
	...
	(function (window, $, moment, React, $pt) {
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(divCSS) }, React.createElement("div", { className: "input-group", ref: "div" }, React.createElement("input", { type: "text",
					className: "form-control",
					disabled: !this.isEnabled(),

					onFocus: this.onComponentFocused,
					onBlur: this.onComponentBlurred }), React.createElement("span", { className: $pt.LayoutHelper.classSet(css) }, React.createElement("span", { className: "fa fa-fw fa-calendar" }))), this.renderNormalLine(), this.renderFocusLine());
			},
	...
	(function (window, $, React, $pt) {
			...
			statics: {
				getExceptionModal: function (className) {
					if ($pt.exceptionDialog === undefined || $pt.exceptionDialog === null) {
						...
						$pt.exceptionDialog = React.render(React.createElement($pt.Components.NExceptionModal, { className: className }), document.getElementById("exception_modal_container"));
					}
	   ...
	   */
			renderContent: function () {
				...
				return React.createElement("div", null, React.createElement("h6", null, status, ": ", statusMessage), message != null ? React.createElement("pre", null, message) : null);
			},
			/**
	   * render
	   * @returns {*}
	   */
			render: function () {
				...
				return React.createElement("div", null, React.createElement("div", { className: "modal-backdrop fade in", style: { zIndex: NExceptionModal.Z_INDEX } }), React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
					tabIndex: "-1",
					role: "dialog",
					style: { display: 'block', zIndex: NExceptionModal.Z_INDEX + 1 } }, React.createElement("div", { className: "modal-danger modal-dialog" }, React.createElement("div", { className: "modal-content", role: "document" }, React.createElement("div", { className: "modal-header" }, React.createElement("button", { className: "close",
					onClick: this.hide,
					"aria-label": "Close",
					style: { marginTop: '-2px' } }, React.createElement("span", { "aria-hidden": "true" }, "×")), React.createElement("h4", { className: "modal-title" }, NExceptionModal.TITLE)), React.createElement("div", { className: "modal-body" }, this.renderContent())))));
			},
			onDocumentKeyUp: function (evt) {
				if (evt.keyCode === 27) {
					// escape
	...
	(function (window, $, React, $pt) {
		var NFile = React.createClass($pt.defineCellComponent({
			...
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css), ref: "comp" }, React.createElement("input", { type: "file",
					className: $pt.LayoutHelper.classSet(inputCSS),
					multiple: this.allowMultipleFiles(),
					disabled: !this.isEnabled(),
					ref: "file" }), this.renderNormalLine(), this.renderFocusLine());
			},
			createDisplayOptions: function (options) {
				var _this = this;
				Object.keys(options).forEach(function (key) {
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderCard: function (card, isCards, index) {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css), key: index }, this.renderSections(card.getSections()), footer);
			},
			/**
	   * render badge
	   * @param card
	   ...
	   */
			renderWizards: function () {
				...
				var _this = this;
				return React.createElement("ul", { className: css, key: "wizards" }, this.getLayout().getCards().map(function (card, cardIndex) {
					var css = {
					...
					return React.createElement("li", { className: $pt.LayoutHelper.classSet(css), key: cardIndex }, React.createElement("a", { href: "javascript:void(0);", onClick: click }, icon, " ", card.getLabel(), _this.renderBadge(card)));
				}));
			},
			/**
	   * render cards
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderInputComponent: function (componentDefinition) {
				...
				return React.createElement("div", { ref: "comp" }, $pt.LayoutHelper.getComponentRenderer(type).call(this, this.getFormModel(), this.getLayout(), direction, this.isViewMode()));
			},
			/**
	   * render label
	   * @returns {XML}
	   */
			renderLabel: function () {
				...
				return React.createElement("span", { className: this.getLayout().getLabelCSS(), onClick: this.onLabelClicked, ref: "label" }, this.getLayout().getLabel(), tooltipIcon, requiredLabel);
			},
			/**
	   * render
	   * @returns {XML}
	   */
			render: function () {
				...
				if (!visible) {
					...
					if (type.label === false) {
						return React.createElement("div", { className: css, ref: "div" }, this.renderInputComponent(type));
					} else {
						...
						if (labelDirection != 'vertical') {
							return React.createElement("div", { className: css + ' horizontal-label', ref: "div" }, React.createElement("div", { className: "row" }, React.createElement("div", { className: this.getHorizontalLabelCSS() }, this.renderLabel()), React.createElement("div", { className: this.getHorizontalComponentCSS() }, this.renderInputComponent(type))));
						} else {
							return React.createElement("div", { className: css + ' vertical-label', ref: "div" }, this.renderLabel(), this.renderInputComponent(type));
						}
					}
				}
			},
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			...
			render: function () {
				...
				return React.createElement("div", { className: this.getComponentCSS('n-form-tab') }, React.createElement($pt.Components.NTab, { type: this.getComponentOption('tabType'),
					justified: this.getComponentOption('justified'),
					direction: this.getComponentOption('titleDirection'),
					size: this.getComponentOption('titleIconSize'),
					tabClassName: this.getAdditionalCSS('tabs'),
					...
					canActive: canActive,
					onActive: this.onTabClicked,
					ref: "tabs" }), React.createElement("div", { className: "n-form-tab-content", ref: "content" }, this.getTabLayouts().map(this.renderTabContent)));
			},
			getTabs: function () {
	   ...
	   */
			render: function () {
				...
				if (this.props.backIcon) {
					...
					return React.createElement("span", { className: $pt.LayoutHelper.classSet(size), title: this.props.tooltip }, React.createElement("i", { className: $pt.LayoutHelper.classSet(iconClasses) }), React.createElement("i", { className: $pt.LayoutHelper.classSet(backIconClasses) }));
				}
	...
	(function (window, $, React, $pt) {
		var NJumbortron = React.createClass({
			...
			render: function () {
				return React.createElement("div", { className: "n-jumbotron jumbotron" }, this.renderText());
			}
		});
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			...
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, texts.map(function (text, textIndex) {
	...
	(function (window, $, React, $pt) {
			...
			statics: {
				getConfirmModal: function (className) {
					if ($pt.confirmDialog === undefined || $pt.confirmDialog === null) {
						...
						$pt.confirmDialog = React.render(React.createElement($pt.Components.NConfirm, { className: className }), document.getElementById("confirm_modal_container"));
					}
	   ...
	   */
			renderFooter: function () {
				...
				return React.createElement("div", { className: "modal-footer" }, this.renderCloseButton(), this.renderConfirmButton());
			},
			/**
	   * render content
	   */
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", null, React.createElement("div", { className: "modal-backdrop fade in", style: { zIndex: NConfirm.Z_INDEX } }), React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
					tabIndex: "-1",
					role: "dialog",
					style: { display: 'block', zIndex: NConfirm.Z_INDEX + 1 } }, React.createElement("div", { className: "modal-dialog" }, React.createElement("div", { className: "modal-content", role: "document" }, React.createElement("div", { className: "modal-header" }, React.createElement("button", { className: "close",
					onClick: this.onCancelClicked,
					"aria-label": "Close",
					style: { marginTop: '-2px' } }, React.createElement("span", { "aria-hidden": "true" }, "×")), React.createElement("h4", { className: "modal-title" }, this.state.title)), React.createElement("div", { className: "modal-body" }, this.renderContent()), this.renderFooter()))));
			},
			onDocumentKeyUp: function (evt) {
				if (evt.keyCode === 27) {
					// escape
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderFooter: function () {
				if (this.state.footer === false || !this.state.expanded) {
					...
					return React.createElement("div", { className: "n-modal-form-footer modal-footer", ref: "footer" }, React.createElement($pt.Components.NPanelFooter, { reset: this.getResetButton(),
			...
			renderBody: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, React.createElement($pt.Components.NForm, { model: this.getModel(),
			...
			renderCloseButton: function () {
				if (this.isDialogCloseShown()) {
					return React.createElement("button", { className: "close",
						onClick: this.hide,
						"aria-label": "Close",
						style: { marginTop: '-2px' } }, React.createElement("span", { "aria-hidden": "true" }, "×"));
				}
				return null;
			},
			/**
	   ...
	   */
			render: function () {
				...
				// tabindex="0"
				return React.createElement("div", { ref: "top" }, React.createElement("div", { className: "modal-backdrop fade in", style: { zIndex: this.props.zIndex * 1 } }), React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
					role: "dialog",
					style: { display: 'block', zIndex: this.props.zIndex * 1 + 1 } }, React.createElement("div", { className: "modal-dialog" }, React.createElement("div", { className: "modal-content", role: "document" }, React.createElement("div", { className: "modal-header" }, this.renderCloseButton(), React.createElement("h4", { className: "modal-title" }, title)), this.renderBody(), this.renderFooter()))));
			},
			onDocumentKeyUp: function (evt) {
				if (evt.keyCode === 27) {
					// escape
	...
	(function (window, $, React, $pt) {
		var NNormalLabel = React.createClass({
			...
			render: function () {
				...
				return React.createElement("span", { className: $pt.LayoutHelper.classSet(css) }, texts.map(function (text, textIndex) {
					return React.createElement("span", { key: textIndex }, text);
				}));
			},
			getText: function () {
	...
	(function (window, $, React, $pt) {
			...
			statics: {
				getOnRequestModal: function (className) {
					if ($pt.onRequestDialog === undefined || $pt.onRequestDialog === null) {
						...
						$pt.onRequestDialog = React.render(React.createElement($pt.Components.NOnRequestModal, { className: className }), document.getElementById("onrequest_modal_container"));
					}
	   ...
	   */
			...
			render: function () {
				...
				return React.createElement("div", null, React.createElement("div", { className: "modal-backdrop fade in", style: { zIndex: NOnRequestModal.Z_INDEX } }), React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
					tabIndex: "-1",
					role: "dialog",
					style: { display: 'block', zIndex: NOnRequestModal.Z_INDEX + 1 } }, React.createElement("div", { className: "modal-danger modal-dialog" }, React.createElement("div", { className: "modal-content", role: "document" }, React.createElement("div", { className: "modal-body", ref: "body" }, React.createElement("span", { className: "fa fa-fw fa-lg fa-spin fa-spinner" }), " ", NOnRequestModal.WAITING_MESSAGE)))));
			},
			/**
	   * hide dialog
	   */
	...
	(function (window, $, React, $pt) {
		var NPageFooter = React.createClass({
			...
			render: function () {
				return React.createElement("footer", { className: "footer" }, React.createElement("div", { className: "container" }, React.createElement("p", { className: "text-muted", style: { display: 'inline-block' } }, React.createElement("span", null, NPageFooter.LEFT_TEXT)), React.createElement("p", { className: "text-muted pull-right", style: { display: 'inline-block' } }, this.props.name, this.renderTech(), this.renderCompany(), ".")));
			}
		});
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderSearchBox: function () {
				...
				return React.createElement("div", { className: "navbar-form navbar-right", role: "search" }, React.createElement($pt.Components.NText, { model: this.state.model, layout: layout }));
			},
			renderMenuItem: function (item, index, menus, onTopLevel) {
				if (item.children !== undefined) {
					// render dropdown menu
					var _this = this;
					return React.createElement("li", { className: onTopLevel ? "dropdown" : "dropdown-submenu", key: index }, React.createElement("a", { href: "#", className: "dropdown-toggle", "data-toggle": "dropdown", role: "button",
						"aria-expanded": "false" }, item.text, " ", onTopLevel ? React.createElement("span", { className: "caret" }) : null), React.createElement("ul", { className: "dropdown-menu", role: "menu" }, item.children.map(function (childItem, childIndex, dropdownItems) {
					...
					return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", onClick: this.onMenuClicked.bind(this, item.func), key: index }, item.text));
				} else {
					// jump to url
	   ...
	   */
			renderMenus: function () {
				...
				return React.createElement("ul", { className: $pt.LayoutHelper.classSet(css) }, this.props.menus.map(function (item, index, menu) {
			...
			renderBrand: function () {
				if (this.props.brandUrl) {
					...
					return React.createElement("a", { href: "javascript:void(0);",
						...
						onClick: this.onBrandClicked }, React.createElement("span", { className: "navbar-brand" }, this.props.brand));
				} else {
	   ...
	   */
			render: function () {
				return React.createElement("nav", { className: "navbar navbar-default navbar-fixed-top" }, React.createElement("div", { className: "container-fluid" }, React.createElement("div", { className: "navbar-header" }, React.createElement("button", { type: "button", className: "navbar-toggle collapsed", "data-toggle": "collapse",
					"data-target": "#navbar-1" }, React.createElement("span", { className: "sr-only" }, "Toggle navigation"), React.createElement("span", { className: "icon-bar" }), React.createElement("span", { className: "icon-bar" }), React.createElement("span", { className: "icon-bar" })), this.renderBrand()), React.createElement("div", { className: "collapse navbar-collapse", id: "navbar-1" }, this.props.menus ? this.renderMenus() : null, this.props.search ? this.renderSearchBox() : null)));
			}
		});
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderFirst: function (buttonsRange) {
				return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", "aria-label": "First", onClick: this.toFirst }, React.createElement("span", { className: "fa fa-fw fa-fast-backward" })));
			},
			/**
	   ...
	   */
			renderPreviousSection: function (buttonsRange) {
				return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", "aria-label": "PreviousSection", onClick: this.toPreviousSection }, React.createElement("span", { className: "fa fa-fw fa-backward" })));
			},
			/**
	   ...
	   */
			renderPrevious: function (buttonsRange) {
				return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", "aria-label": "Previous", onClick: this.toPrevious }, React.createElement("span", { className: "fa fa-fw fa-chevron-left" })));
			},
			/**
	   * render buttons
	   * @param buttonsRange
	   ...
	   */
			renderButtons: function (buttonsRange) {
				...
				return buttons.map(function (index) {
					...
					return React.createElement("li", { key: index }, React.createElement("a", { href: "javascript:void(0);",
	   ...
	   */
			renderNext: function (buttonsRange) {
				return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", "aria-label": "Next", onClick: this.toNext }, React.createElement("span", { className: "fa fa-fw fa-chevron-right" })));
			},
			/**
	   ...
	   */
			renderNextSection: function (buttonsRange) {
				return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", "aria-label": "NextSection", onClick: this.toNextSection }, React.createElement("span", { className: "fa fa-fw fa-forward" })));
			},
			/**
	   ...
	   */
			renderLast: function (buttonsRange) {
				return React.createElement("li", null, React.createElement("a", { href: "javascript:void(0);", "aria-label": "Last", onClick: this.toLast }, React.createElement("span", { className: "fa fa-fw fa-fast-forward" })));
			},
			/**
	   * render status
	   * @returns {XML}
	   */
			renderStatus: function () {
				if (this.props.showStatus) {
					return React.createElement("div", { className: "n-pagination-status col-sm-2 col-md-2 col-lg-2" }, React.createElement("div", null, "Page: ", this.getCurrentPageIndex(), " / ", this.getPageCount()));
				} else {
					return null;
				}
			},
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderCheckInTitle: function () {
				...
				return React.createElement("div", null, "(", React.createElement($pt.Components.NCheck, { model: this.getModel(), layout: $pt.createCellLayout('check', layout), view: this.isViewMode() }), ")");
			},
			/**
	   * render heading
	   * @returns {XML}
	   */
			renderHeading: function () {
				...
				if (this.isCollapsible()) {
					...
					return React.createElement("div", { className: "panel-heading" }, React.createElement("h4", { className: $pt.LayoutHelper.classSet(css) }, React.createElement("a", { href: "javascript:void(0);", onClick: this.onTitleClicked, ref: "head" }, label), this.renderCheckInTitle()));
				} else if (this.hasCheckInTitle()) {
					css['n-normal-title-check'] = this.hasCheckInTitle();
					return React.createElement("div", { className: "panel-heading" }, React.createElement("h4", { className: $pt.LayoutHelper.classSet(css) }, React.createElement("span", { ref: "head" }, label), this.renderCheckInTitle()));
				} else {
	   ...
	   */
			render: function () {
				var label = this.getLayout().getLabel();
				if (label == null) {
					return React.createElement("div", { ref: "panel" }, this.getInnerLayout().getRows().map(this.renderRow));
				}
				var css = {
					panel: true
				};
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css), ref: "panel" }, this.renderHeading(), React.createElement("div", { className: "panel-body", style: bodyStyle, ref: "body" }, this.getInnerLayout().getRows().map(this.renderRow)));
			},
			/**
	   * get inner layout
	   * @returns {SectionLayout}
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			render: function () {
				return React.createElement("div", { className: "row n-panel-footer" }, React.createElement("div", { className: "col-sm-12 col-md-12 col-lg-12" }, React.createElement("div", { className: "btn-toolbar n-panel-footer-left", role: "toolbar" }, this.props.reset ? this.renderButton({
				...
				}) : null, this.props.validate ? this.renderButton({
				...
				}) : null, this.renderLeftButtons()), React.createElement("div", { className: "btn-toolbar n-panel-footer-right", role: "toolbar" }, this.props.cancel ? this.renderButton({
				...
				}) : null, this.props.save ? this.renderButton({
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderLabel: function (option, labelInLeft) {
				...
				return React.createElement("span", { className: $pt.LayoutHelper.classSet(css),
					onClick: this.isEnabled() && !this.isViewMode() ? this.onButtonClicked.bind(this, option) : null }, option.text);
			},
			/**
	   ...
	   */
			renderRadio: function (option, optionIndex) {
				...
				return React.createElement("div", { className: "n-radio-option", key: optionIndex }, labelAtLeft ? this.renderLabel(option, true) : null, React.createElement("div", { className: "radio-container" }, React.createElement("span", { className: $pt.LayoutHelper.classSet(css),
					...
					tabIndex: "0",
					ref: 'out-' + option.id }, React.createElement("span", { className: "check", onClick: this.onInnerClicked.bind(this, option) }))), labelAtLeft ? null : this.renderLabel(option, false));
			},
			render: function () {
				var css = {
					'n-radio': true,
				...
				// 	   ref='txt'/>
				return React.createElement("div", { className: this.getComponentCSS($pt.LayoutHelper.classSet(css)) }, this.getComponentOption("data").map(this.renderRadio));
			},
			/**
	   * inner span clicked, force focus to outer span
	   * for fix the outer span cannot gain focus in IE11
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: this.getComponentCSS($pt.LayoutHelper.classSet(css)) }, React.createElement("div", { className: "input-group" }, React.createElement("input", { type: "text", className: "form-control search-code", onKeyUp: this.onComponentChange, ref: "code",
					disabled: !enabled, onFocus: this.onComponentFocused, onBlur: this.onComponentBlurred }), React.createElement("span", { className: "input-group-btn", style: middleSpanStyle }), React.createElement("input", { type: "text", className: "form-control search-label", onFocus: this.onLabelFocused, ref: "label",
					disabled: !enabled }), React.createElement("span", { className: "input-group-addon advanced-search-btn",
					onClick: enabled ? this.showAdvancedSearchDialog : null }, React.createElement("span", { className: 'fa fa-fw fa-' + NSearchText.ADVANCED_SEARCH_BUTTON_ICON })), this.renderNormalLine(), this.renderFocusLine()));
			},
			/**
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css),
					ref: "div" }, React.createElement("select", { style: { width: this.getComponentOption("width") },
					disabled: !this.isEnabled(),
					ref: "select" }));
			},
			/**
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			...
			renderText: function () {
				...
				return React.createElement("div", { className: "input-group form-control", onClick: this.onComponentClicked, ref: "comp" }, React.createElement("span", { className: "text" }, itemText), this.renderClear(), React.createElement("span", { className: "fa fa-fw fa-sort-down drop" }));
			},
			/**
	   * render
	   * @returns {XML}
	   */
			render: function () {
				...
				css[this.getComponentCSS('n-select')] = true;
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css), tabIndex: "0" }, this.renderText(), this.renderNormalLine(), this.renderFocusLine());
			},
			renderPopoverContainer: function () {
			...
			renderOptions: function (options, filterText) {
				...
				var _this = this;
				return React.createElement("ul", null, options.map(function (item, itemIndex) {
					return React.createElement("li", { onClick: _this.onOptionClick.bind(_this, item), key: itemIndex }, React.createElement("span", null, item.text));
				}));
			},
			...
			renderPopoverContent: function (filterText) {
				...
				return React.createElement("div", null, this.renderFilterText(options, filterText), this.renderNoOption(options), this.renderOptions(options, filterText));
			},
			renderPopover: function (filterText) {
				...
				styles.left = 0;
				var popover = React.createElement("div", { role: "tooltip", className: "n-select-popover popover bottom in", style: styles }, React.createElement("div", { className: "arrow" }), React.createElement("div", { className: "popover-content" }, this.renderPopoverContent(filterText)));
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			...
			renderSelectionItem: function (codeItem, nodeId) {
				return React.createElement("li", null, React.createElement("span", { className: "fa fa-fw fa-remove", onClick: this.onSelectionItemRemove.bind(this, nodeId) }), codeItem.text);
			},
			...
			renderText: function () {
				return React.createElement("div", { className: "input-group form-control", onClick: this.onComponentClicked, ref: "comp" }, React.createElement("ul", { className: "selection" }, this.renderSelection()), React.createElement("span", { className: "fa fa-fw fa-sort-down pull-right" }));
			},
			render: function () {
				var css = {
					'n-disabled': !this.isEnabled(),
			...
			renderPopover: function () {
				...
				styles.top = -10000; // let it out of screen
				styles.left = 0;
				var popover = React.createElement("div", { role: "tooltip", className: "n-select-tree-popover popover bottom in", style: styles }, React.createElement("div", { className: "arrow" }), React.createElement("div", { className: "popover-content" }, this.renderTree()));
				React.render(popover, this.state.popoverDiv.get(0), this.onPopoverRenderComplete);
			},
			showPopover: function () {
				this.renderPopoverContainer();
	    ...
	    */
				getSideMenu: function (menus, containerId, className, hover) {
					...
					if ($pt.sideMenu[containerId] == null) {
						...
						$pt.sideMenu[containerId] = React.render(React.createElement($pt.Components.NSideMenu, { menus: menus,
							className: className,
			...
			renderMenuItem: function (item, index, menus, onTopLevel) {
				if (item.children !== undefined) {
					...
					var _this = this;
					var id = 'item_' + index;
					return React.createElement("li", { ref: id, key: index }, React.createElement("a", { href: "javascript:void(0);",
						onClick: this.onParentMenuClicked.bind(this, id), ref: id + '_link' }, item.text, React.createElement("span", { className: "fa fa-fw fa-angle-double-down n-side-menu-ul", ref: id + '_icon' })), React.createElement("ul", { ref: id + '_child', style: { display: 'none' } }, item.children.map(function (childItem, childIndex, dropdownItems) {
			...
			render: function () {
				...
				return React.createElement("div", { className: "n-side-menu", ref: "menus",
					onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave }, React.createElement("ul", { className: "nav navbar-nav" }, this.props.menus.map(function (item, index, menu) {
					return _this.renderMenuItem(item, index, menu, true);
				}), React.createElement("li", { className: "n-side-menu-close" }, React.createElement("a", { href: "javascript:void(0);", onClick: this.onCloseClicked }, React.createElement("span", { className: "fa fa-fw fa-arrow-circle-left" })))));
			},
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderTab: function (tab, index) {
				...
				var removeButton = React.createElement("a", { href: "javascript:void(0);", className: "n-tab-delete",
					onClick: this.onRemoveClicked }, React.createElement("span", { className: "fa fa-fw fa-times" }));
				return React.createElement("li", { role: "presentation", className: css, key: index }, React.createElement("a", { href: "javascript:void(0);", onClick: this.onClicked }, this.renderIcon(tab.icon, this.props.size), this.renderLabel(tab.label), this.renderBadge(tab.badge)), this.canRemove(tab) ? removeButton : null);
			},
			/**
	   * render
	   * @returns {XML}
	   */
			render: function () {
				...
				return React.createElement("div", { className: "n-tab" }, React.createElement("ul", { className: $pt.LayoutHelper.classSet(css), ref: "tabs" }, this.props.tabs.map(this.renderTab)));
			},
			/**
	...
	(function (window, $, React, $pt) {
			...
			renderHeadingButtons: function () {
				if (this.isAddable()) {
					return React.createElement("a", { href: "javascript:void(0);",
						...
						} }, React.createElement($pt.Components.NIcon, { icon: NTable.ADD_BUTTON_ICON }), NTable.ADD_BUTTON_TEXT);
				} else {
					return null;
				}
			},
	   ...
	   */
			renderPanelHeadingLabel: function () {
				...
				return React.createElement("div", { className: css }, React.createElement("span", { className: this.getAdditionalCSS("headingLabel", $pt.LayoutHelper.classSet(spanCSS)),
					ref: this.getHeaderLabelId(), onClick: this.isCollapsible() ? this.onTitleClicked : null }, this.getLayout().getLabel()));
			},
			/**
	   ...
	   */
			renderPanelHeading: function () {
				...
				return React.createElement("div", { className: this.getAdditionalCSS("heading", "panel-heading n-table-heading") }, React.createElement("div", { className: "row" }, this.renderPanelHeadingLabel(), React.createElement("div", { className: "col-sm-9 col-md-9 col-lg-9" }, this.renderHeadingButtons(), this.renderSearchBox())));
			},
			/**
	   * render sort button
	   * @param column
			...
			renderTableHeaderSortButton: function (column) {
				if (this.isSortable(column)) {
					...
					return React.createElement("a", { href: "javascript:void(0);", className: sortClass,
						onClick: this.onSortClicked.bind(this, column) }, React.createElement($pt.Components.NIcon, { icon: icon }));
				}
			},
			/**
	   * render checkbox
	   ...
	   */
			renderTableHeading: function (all, leftFixed, rightFixed) {
				...
				var columnIndex = 0;
				var _this = this;
				return React.createElement("thead", null, React.createElement("tr", null, this.state.columns.map(function (column) {
					if (columnIndex >= indexToRender.min && columnIndex <= indexToRender.max) {
						...
						if (column.rowSelectable) {
							return React.createElement("td", { style: style, key: columnIndex }, _this.renderTableHeaderCheckBox(column));
						} else {
							return React.createElement("td", { style: style, key: columnIndex }, column.title, _this.renderTableHeaderSortButton(column));
						}
					} else {
						columnIndex++;
					}
	   ...
	   */
			renderFlatOperationCell: function (column, rowModel) {
				...
				var _this = this;
				return React.createElement("div", { className: "btn-group n-table-op-btn-group", role: "group" }, rowOperations.map(function (operation, operationIndex) {
	   ...
	   */
			...
			renderPopoverAsMenu: function (moreOperations, rowModel) {
				...
				var renderOperation = function (operation, operationIndex) {
					...
					return React.createElement("li", { key: operationIndex }, React.createElement($pt.Components.NFormButton, { model: rowModel, layout: layout }));
				};
	   ...
	   */
			renderDropDownOperationCell: function (column, rowModel, maxButtonCount) {
				...
				return React.createElement("div", { className: "btn-group n-table-op-btn-group", role: "group" }, buttons, dropdown);
			},
			/**
	   ...
	   */
			renderTableBodyRow: function (row, rowIndex, all, leftFixed, rightFixed) {
				...
				return React.createElement("tr", { className: className, key: rowIndex }, this.state.columns.map(function (column) {
					if (columnIndex >= indexToRender.min && columnIndex <= indexToRender.max) {
						// column is fixed.
						columnIndex++;
						var style = {
						...
						if (column.editable || column.removable || column.rowOperations != null) {
							...
							if (typeof column.inline === 'string') {
								...
								layout.pos = { width: 12 };
								if (layout.css) {
									layout.css.cell =  true ? ' ' + layout.css.cell : '';
								} else {
								...
								if (column.inline.css) {
									column.inline.css.cell =  true ? ' ' + column.inline.css.cell : '';
								} else {
	   ...
	   */
			renderTableBody: function (all, leftFixed, rightFixed) {
				...
				var _this = this;
				var range = this.computePagination(data);
				return React.createElement("tbody", null, data.map(function (element) {
					if (rowIndex >= range.min && rowIndex <= range.max) {
	   ...
	   */
			renderTableNoScrollY: function () {
				return React.createElement("div", { className: this.getAdditionalCSS("panelBody", "n-table-panel-body") }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border"),
					style: this.computeTableStyle(),
					ref: "table" }, this.renderTableHeading(true), this.renderTableBody(true)));
			},
			/**
	   ...
	   */
			renderTableScrollY: function () {
				...
				return React.createElement("div", { className: this.getAdditionalCSS("panelBody", "n-table-panel-body") }, React.createElement("div", { className: "n-table-scroll-head", ref: this.getScrolledHeaderDivId(), style: scrolledHeaderDivStyle }, React.createElement("div", { className: "n-table-scroll-head-inner", style: style }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border"),
					style: style }, this.renderTableHeading(true)))), React.createElement("div", { className: "n-table-scroll-body", style: scrolledBodyDivStyle, ref: this.getScrolledBodyDivId() }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border"),
					style: style,
					ref: "table" }, this.renderTableBody(true))));
			},
			/**
	   * render table
	   * @returns {XML}
	   ...
	   */
			renderFixedLeftColumnsScrollY: function () {
				...
				return React.createElement("div", { className: "n-table-fix-left", style: divStyle }, React.createElement("table", { cellSpacing: "0", style: tableStyle,
					className: this.getAdditionalCSS("table", "n-table cell-border") }, this.renderTableHeading(false, true)), React.createElement("div", { ref: this.getFixedLeftBodyDivId(), style: bodyDivStyle }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border"),
					style: tableStyle }, this.renderTableBody(false, true))));
			},
			/**
	   ...
	   */
			renderFixedLeftColumnsNoScrollY: function () {
				...
				return React.createElement("div", { className: "n-table-fix-left", style: divStyle }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border"),
					style: tableStyle }, this.renderTableHeading(false, true), this.renderTableBody(false, true)));
			},
			/**
	   ...
	   */
			renderFixedRightColumnsNoScrollY: function () {
				...
				return React.createElement("div", { className: "n-table-fix-right", style: divStyle }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border"),
					style: tableStyle }, this.renderTableHeading(false, false, true), this.renderTableBody(false, false, true)));
			},
			/**
	   ...
	   */
			renderFixedRightColumnsScrollY: function () {
				...
				return React.createElement("div", { className: "n-table-fix-right", style: divStyle }, React.createElement("div", { className: "n-table-fix-right-head-wrapper" }, React.createElement("div", { className: "n-table-fix-right-top-corner" }), React.createElement("table", { cellSpacing: "0", style: tableStyle,
					className: this.getAdditionalCSS("table", "n-table cell-border") }, this.renderTableHeading(false, false, true))), React.createElement("div", { ref: this.getFixedRightBodyDivId(), style: bodyDivStyle }, React.createElement("table", { cellSpacing: "0", className: this.getAdditionalCSS("table", "n-table cell-border") }, this.renderTableBody(false, false, true))));
			},
			/**
	   ...
	   */
			...
			renderRightTopCorner: function () {
				...
				if (this.hasVerticalScrollBar() && !this.hasFixedRightColumns()) {
					...
					rightCorner = React.createElement("div", { className: "n-table-fix-right", style: divStyle }, React.createElement("div", { className: "n-table-fix-right-head-wrapper" }, React.createElement("div", { className: "n-table-fix-right-top-corner" })));
				}
				return rightCorner;
			},
			/**
	  ...
	  *              }}
	   ...
	   */
			renderAddon: function (addon) {
				...
				return React.createElement("span", { className: $pt.LayoutHelper.classSet(spanCss),
					onClick: this.onAddonClicked.bind(this, addon.click) }, innerParts.map(function (part) {
					return part;
				}));
			},
			/**
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, React.createElement("div", { className: "input-group" }, this.renderLeftAddon(), this.renderText(), this.renderRightAddon()), this.renderNormalLine(), this.renderFocusLine());
			},
			onComponentFocused: function () {
				$(React.findDOMNode(this.refs.focusLine)).toggleClass('focus');
				$(React.findDOMNode(this.refs.normalLine)).toggleClass('focus');
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, this.renderText(), this.renderNormalLine(), this.renderFocusLine());
			},
			onComponentFocused: function () {
				$(React.findDOMNode(this.refs.focusLine)).toggleClass('focus');
				$(React.findDOMNode(this.refs.normalLine)).toggleClass('focus');
	...
	(function (window, $, React, $pt) {
	   ...
	   */
			renderLabel: function (label, className) {
				...
				css[className] = true;
				return React.createElement("span", { className: $pt.LayoutHelper.classSet(css) }, label);
			},
	   ...
	   */
			renderToggleButton: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, React.createElement("span", { className: "n-toggle-line" }), React.createElement("span", { className: "n-toggle-true",
					tabIndex: "-1",
					onClick: this.onButtonClicked.bind(this, true) }), React.createElement("span", { className: "n-toggle-false",
					tabIndex: "-1",
	   ...
	   */
			render: function () {
				...
				return React.createElement("div", { className: $pt.LayoutHelper.classSet(css) }, React.createElement("input", { type: "checkbox", style: { display: "none" },
					onChange: this.onComponentChanged, ref: "txt" }), this.renderLeftLabel(), this.renderToggleButton(), this.renderRightLabel());
			},
			/**
	   * handle button clicked event
	   */
	  ...
	  */
	   ...
	   */
			...
			renderNode: function (parentNodeId, node) {
				...
				if (this.getComponentOption('opIconEnabled')) {
					...
					opIcon = React.createElement("a", { href: "javascript:void(0);",
						onClick: this.onNodeClicked.bind(this, node, nodeId) }, React.createElement($pt.Components.NIcon, React.__spread({}, expandableIconAttrs)));
				}
				var folderIconAttrs = {
				...
				var folderIcon = React.createElement("a", { href: "javascript:void(0);",
					onClick: this.onNodeClicked.bind(this, node, nodeId) }, React.createElement($pt.Components.NIcon, React.__spread({}, folderIconAttrs)));

				var active = this.isActive(nodeId) ? 'active' : null;
				return React.createElement("li", { className: active, key: nodeId }, opIcon, folderIcon, this.renderCheck(node, nodeId), React.createElement("a", {
					href: "javascript:void(0);",
					onClick: this.onNodeClicked.bind(this, node, nodeId) }, React.createElement("span", { className: "node-text" }, this.getNodeText(node))), this.renderNodes(node, nodeId));
			},
			renderNodes: function (parent, parentNodeId) {
				var children = parent.children;
				if (children && children.length > 0) {
					return React.createElement("ul", { className: "nav" }, children.map(this.renderNode.bind(this, parentNodeId)));
				} else {
					return null;
				}
			},
			renderRoot: function () {
				return React.createElement("ul", { className: "nav" }, this.renderNode(null, this.state.root));
			},
			...
			renderButtons: function () {
				...
				if (expand || collapse) {
					return React.createElement("span", { className: "buttons" }, expand, collapse);
				} else {
					return null;
				}
			},
			render: function () {
				...
				return React.createElement("div", { className: css, style: styles }, this.renderTopLevel(), this.renderButtons());
			},
